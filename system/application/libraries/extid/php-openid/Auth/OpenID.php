 ...
 *
 * NOTE:
 * This distribution has been modified for use in the EasyOpenID
 * library <http://code.kbjrweb.com/pages/project/easyopenid>. Do
 * NOT try to use this distribution seperate from the EasyOpenID
 * library as it will not function.
 *
 * @package OpenID
 ...
 */
require_once OPENID_DIRECTORY."Auth/Yadis/PlainHTTPFetcher.php";
require_once OPENID_DIRECTORY."Auth/Yadis/ParanoidHTTPFetcher.php";
