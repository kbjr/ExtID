...
require_once OPENID_DIRECTORY."Auth/OpenID/BigMath.php";
require_once OPENID_DIRECTORY."Auth/OpenID/DiffieHellman.php";
require_once OPENID_DIRECTORY."Auth/OpenID/KVForm.php";
require_once OPENID_DIRECTORY."Auth/OpenID/TrustRoot.php";
require_once OPENID_DIRECTORY."Auth/OpenID/ServerRequest.php";
