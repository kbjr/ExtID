...
require_once OPENID_DIRECTORY."Auth/OpenID/Parse.php";
require_once OPENID_DIRECTORY."Auth/OpenID/Message.php";
require_once OPENID_DIRECTORY."Auth/Yadis/XRIRes.php";
require_once OPENID_DIRECTORY."Auth/Yadis/Yadis.php";
